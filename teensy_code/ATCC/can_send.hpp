...
void send_ATCCF_12(){
  ...
  msg.buf[0] = ctr.value();
  msg.buf[1] = 0;
  msg.buf[2] = ATCCF_coolantTempRadMiddle.can_value();
  msg.buf[3] = ATCCF_coolantTempRadMiddle.can_value() >> 8;
...
void send_ATCCF_15(){
  ...
  msg.buf[0] = ctr.value();
  msg.buf[1] = 0;
  msg.buf[2] = ATCCF_boardTemp.can_value();
  msg.buf[3] = ATCCF_boardTemp.can_value() >> 8;
  msg.buf[4] = ATCCF_teensyTemp.can_value();
  msg.buf[5] = ATCCF_teensyTemp.can_value() >> 8;
  msg.buf[6] = 0;
  msg.buf[7] = 0;
